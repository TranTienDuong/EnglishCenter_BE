...
public class LopHocController {
    ...
    @GetMapping("/dslopcungkhoa/{maLopCu}")
    public ResponseEntity<List<LopHoc>> getLopCungKhoaHoc(@PathVariable Long maLopCu) {
        return ResponseEntity.ok(lophocService.getLopCungKhoaHocDeChuyen(maLopCu));
    }
